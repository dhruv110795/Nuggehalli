...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"NSLNSS","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (process.client && typeof nuxt_plugin_vuecarouselclient_7557b44a === 'function') {
    await nuxt_plugin_vuecarouselclient_7557b44a(app.context, inject)
  }

  if (typeof nuxt_plugin_fontawesome_4e2e0728 === 'function') {
    await nuxt_plugin_fontawesome_4e2e0728(app.context, inject)
  }
